...
export default function About(props) {
  ...
  return (
    ...
    <div className="accordion" id="accordionExample" style={myStyle}>
      ...
      <div className="accordion-item">
        <h2 className="accordion-header">
          <button className="accordion-button collapsed" type="button" style={myStyle}  data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" fdprocessedid="brvf6a">
            Accordion Item #2
          </button>
        </h2>
      ...
      <div className="accordion-item">
        <h2 className="accordion-header">
          <button className="accordion-button collapsed" type="button" style={myStyle}  data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" fdprocessedid="5q1jeo">
            Accordion Item #3
          </button>
        </h2>
